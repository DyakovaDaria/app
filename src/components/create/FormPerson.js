    ...
    <>
      <div className="popup-frame mt10">
        ...
        <div className="mt10 t-center">
          <i
            className={`btn-arrow fa-solid fa-angle-down ${
      ...
      {dropdown ? (
        <div className="popup-dropdown pb25">
          ...
          <input
            ...
            onChange={(e) => setPersonForm(i, "lang", e.target.value)}
          />
          ...
          <div className="mt30">
            <div className="frame-area t-center text-grey">
              <input
                ...
                type="number"
                placeholder="10"
                onChange={(e) => setPersonForm(i, "skill1", e.target.value)}
              />
            ...
            <div className="frame-area t-center text-grey mt10">
              <input
                ...
                type="number"
                placeholder="10"
                onChange={(e) => setPersonForm(i, "skill2", e.target.value)}
              />
            ...
            <div className="frame-area t-center text-grey mt10">
              <input
                ...
                type="number"
                placeholder="10"
                onChange={(e) => setPersonForm(i, "skill3", e.target.value)}
              />
